...
export default function SearchWithStatus() {
  ...
  const options = ["Статус","Активан", "У пензији", "Преминуо"];
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          ...
          <div className="h-6 border-l border-dark-coffee-200 ml-1" />
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"  className="w-2 h-2 mr-2" />
</svg>
